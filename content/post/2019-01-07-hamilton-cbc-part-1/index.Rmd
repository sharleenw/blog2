...
date: '2019-01-07'
slug: hamilton-cbc-part-1
description: Importing and cleaning 100 years of the Hamilton Christmas Bird Count data.
summary: Importing and cleaning 100 years of the Hamilton Christmas Bird Count data.
draft: false
...
twitterImg: https://www.publicdomainpictures.net/pictures/250000/velka/black-capped-chickadee-on-branch-3.jpg
...
coverCaption: "A Black-capped Chickadee on a branch (Source: Public Domain Pictures)"
...
We almost have a clean dataset! `r emo::ji("soon")` `r emo::ji("sparkles")``r emo::ji("sparkles")``r emo::ji("sparkles")``r emo::ji("tada")`
