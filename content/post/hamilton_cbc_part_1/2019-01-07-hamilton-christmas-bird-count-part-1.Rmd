...
Now we can clean this up a bit using the `janitor` package `r emo::ji("heart")`! This package will remove any empty columns, convert the top row to the column names of the dataset and it will clean the names.
