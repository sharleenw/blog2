...
coverImage: https://images.unsplash.com/photo-1517935706615-2717063c2225?ixlib=rb-1.2.1&auto=format&fit=crop&w=701&q=80
coverCaption: "Aerial view of Toronto (Source: Unsplash)"
thumbnailImage: https://images.unsplash.com/photo-1517935706615-2717063c2225?ixlib=rb-1.2.1&auto=format&fit=crop&w=701&q=80
...
Today we will be making this in PDF, using a tidy dataframe of city population data:

![](/img/image_of_tables_in_pdf.PNG)
...
The document `r emo::ji("sparkles")`[Create Awesome LaTeX Table with knitr::kable and kableExtra](https://haozhu233.github.io/kableExtra/awesome_table_in_pdf.pdf)`r emo::ji("sparkles")`, written by Hao Zhu! It's got everything you need in order to make fantastic tables in PDF using RMarkdown.
...
`r paste(readLines(here::here("content", "post", "2019-09-01-tables-in-pdf", "largest_canadian_cities.Rmd")), collapse = '\n')`
